...
router.get(
    '/tasks', async (req: express.Request, res: express.Response) => {
...
router.get(
    '/tasks/:id', async (req: express.Request, res: express.Response) => {
...
router.delete(
    '/task', async (req: express.Request, res: express.Response) => {
